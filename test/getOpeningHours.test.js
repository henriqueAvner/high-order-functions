...
describe('Testes da função getOpeningHours', () => {
  it('Para o horário de abertura, fechamendo, e a própria hora em si, ao passaro  valor 12, ela será convertida a 0, ', () => {
  ...
  it('Para o horário de abertura, fechamendo, e a própria hora em si, ao passaro  valor 12, ela será convertida a 0, ', () => {
    expect(getOpeningHours('Friday', '12:12-AM')).toBe('The zoo is closed', '00:00-AM');
  });
});
